...
//SOAL 1
//Ubahlah cara pembuatan object pada rapor siswa menjadi pembuatan object menggunakan class javascript versi ES6
class Student {
...
//SOAL 2
//Buatlah fungsi search data dari rapor siswa tersebut yang memiliki nilai suatu mata pelajaran (dinamis ketika mencari nilai mata pelajaran apapun) diatas nilai tertentu
const searchNilaiMapel = (array = [], mapel, nilaiUjian) => {
  return array.filter((siswa) => siswa.nilaiUjian[mapel] > nilaiUjian);
};

const topNilaiIpa = searchNilaiMapel(siswa, "ipa", 75);
console.log(topNilaiIpa);

//SOAL 3
//Buatlah daftar absensi siswa dengan cara mengurutkan daftar rapor sekolah berdasarkan alphabet nama, tanpa merubah daftar ranking siswa

const daftarAbsen = [...urutanSiswa].sort((a, b) =>
  a.nama.localeCompare(b.nama)
);

daftarAbsen.forEach((siswa) => {
  console.log(
    `
